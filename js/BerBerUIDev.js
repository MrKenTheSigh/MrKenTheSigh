...
var BerBer = (function() {
    ...
    var BerTypeEnums = {};
    Object.defineProperties(BerTypeEnums, {
        "Core": {
        ...
        "VideoCanvas": {
            get: function () { return "videocanvas"; },
            configurable: false
        },
        "DrawCanvas": {
            get: function () { return "drawcanvas"; },
            configurable: false
        },
        "Text": {
    ...
    function CoreView(elementType, parentView, options) {
        ...
        this.BerType = BerTypeEnums.Core;
        ...
        this.setBoxEffect = function (visible, type, color) {//TODO animation
            if (visible) {
                _this.boxEffectRange = (_this.getPxW() / 10);
        ...
        var animation = {
            opacity: null,
            transform: null,
            duration_ms: DEFAULT_ANIM_DURATION,
            callback: {
        ...
        */
        ...
        this.endAnimation = function () {
            ...
            this.boxEffectRange = (this.getPxW() / 50);
        ...
        //新版 通用
        this.addListener = function (type, listener, consumeEvent) {
            var consumeEvent = (typeof consumeEvent === "undefined") ? true : consumeEvent;
    ...
    CoreView.prototype.setAppearance = function (options) {
        var doRedraw = (typeof options.redraw === "undefined") ? true : options.redraw;
    ...
    function RootView() {
        ...
        this.BerType = BerTypeEnums.Root;
    ...
    function TextBoxView(parentView, options) {
        ...
        var _this = this;
        this.BerType = BerTypeEnums.TextBox;
        ...
        //
        this.addListener("change", function () { _this.appearance.text = _this.core.value });
        //
    ...
    TextBoxView.prototype.setAppearance = function (options) {
        options.redraw = false;//stop parent-redraw
        CoreView.prototype.setAppearance.call(this, options);
        this.setAppearance_TextBoxView(options);
    ...
    function TextAreaView(parentView, options) {
        ...
        var _this = this;
        this.BerType = BerTypeEnums.TextArea;
    ...
    function VideoView(parentView, options) {
        ...
        var _this = this;
        this.BerType = BerTypeEnums.Video;
    ...
    function CanvasView(parentView, options) {
        ...
        var _this = this;
        this.BerType = BerTypeEnums.Canvas;//
    ...
    function VideoCanvasView(parentView, options) {
        CoreView.call(this, "canvas", parentView, options);
        var _this = this;
        this.BerType = BerTypeEnums.VideoCanvas;//
    ...
    function DrawCanvasView(parentView, options) {
        CoreView.call(this, "canvas", parentView, options);
        var _this = this;
        this.BerType = BerTypeEnums.DrawCanvas;//
    ...
    function TextView(parentView, options) {
        CoreView.call(this, "div", parentView, options);
        var _this = this;
        this.BerType = BerTypeEnums.Text;
            ...
            switch (mode) {
                ...
                default: // & MODE_NORMAL
                    if (this.AutoFontSize) {
                        this.appearance.fontSize = calcAutoFontSize(_this.appearance.text, {w: _this.getPxW(), h: _this.getPxH()});
                    }
    ...
    function ButtonView(parentView, options) {
        ...
        var _this = this;
        this.BerType = BerTypeEnums.Button;
